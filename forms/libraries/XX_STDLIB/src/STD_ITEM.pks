CREATE OR REPLACE PACKAGE STD_ITEM IS
  ...
  --  */
  -- FUNCTION NAVIGABLE RETURN VARCHAR2;
  -- FUNCTION GET_NAVIGABLE RETURN VARCHAR2;
  
  -- PROCEDURE SET_NAVIGABLE;
  ...
  /**
   * Returns the name of the visual attribute currently in force. If no named visual attribute is assigned to the item, returns DEFAULT for a default visual attribute.
   */
  -- FUNCTION VISUAL_ATTRIBUTE RETURN VARCHAR2;
  -- FUNCTION GET_VISUAL_ATTRIBUTE RETURN VARCHAR2;
  
  -- PROCEDURE SET_VISUAL_ATTRIBUTE;
