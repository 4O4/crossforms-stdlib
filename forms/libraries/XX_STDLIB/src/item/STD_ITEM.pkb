CREATE OR REPLACE PACKAGE BODY STD_ITEM IS
  ...
  FUNCTION ITEM_IS_VALID(P_ITEM IN STD_ITEM) RETURN BOOLEAN IS
  BEGIN
    RETURN GET_ITEM_IS_VALID(P_ITEM);
  END ITEM_IS_VALID;


  FUNCTION GET_ITEM_IS_VALID(P_ITEM IN STD_ITEM) RETURN BOOLEAN IS
  BEGIN
    RETURN GET_BOOLEAN_PROPERTY(P_ITEM, STD_ITEM_PROPS.ITEM_IS_VALID);
  END GET_ITEM_IS_VALID;
  

  PROCEDURE SET_ITEM_IS_VALID(P_ITEM IN STD_ITEM, P_IS_VALID IN BOOLEAN) IS
  BEGIN
    SET_BOOLEAN_PROPERTY(P_ITEM, STD_ITEM_PROPS.ITEM_IS_VALID, P_IS_VALID);
  END SET_ITEM_IS_VALID;
