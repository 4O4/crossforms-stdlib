CREATE OR REPLACE PACKAGE STD_ITEM IS
  ...
  /**
   * Returns the BOOLEAN TRUE if the current item is valid, and the BOOLEAN FALSE if the current
   * item is not valid.
   */
  FUNCTION ITEM_IS_VALID(P_ITEM IN STD_ITEM) RETURN BOOLEAN;
  FUNCTION GET_ITEM_IS_VALID(P_ITEM IN STD_ITEM) RETURN BOOLEAN;
