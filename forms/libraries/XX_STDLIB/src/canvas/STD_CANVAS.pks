CREATE OR REPLACE PACKAGE STD_CANVAS IS
  ...
  -- PROCEDURE SET_BACKGROUND_COLOR(P_CANVAS IN STD_CANVAS, P_);
  ...
  -- PROCEDURE SET_FILL_PATTERN(P_CANVAS IN STD_CANVAS, P_);
  ...
  -- PROCEDURE SET_FONT_NAME(P_CANVAS IN STD_CANVAS, P_);


  -- /**
  --  * The size of the font, specified in points.
  --  */
  -- FUNCTION FONT_SIZE(P_CANVAS IN STD_CANVAS) RETURN VARCHAR2;
  -- FUNCTION GET_FONT_SIZE(P_CANVAS IN STD_CANVAS) RETURN VARCHAR2;

  -- PROCEDURE SET_FONT_SIZE(P_CANVAS IN STD_CANVAS, P_);
  ...
  -- PROCEDURE SET_FONT_SPACING(P_CANVAS IN STD_CANVAS, P_);
  ...
  -- PROCEDURE SET_FONT_STYLE(P_CANVAS IN STD_CANVAS, P_);
  ...
  -- PROCEDURE SET_FONT_WEIGHT(P_CANVAS IN STD_CANVAS, P_);
  ...
  -- PROCEDURE SET_FOREGROUND_COLOR(P_CANVAS IN STD_CANVAS, P_);
  ...
  -- /**
  --  * Returns the distance between the left edge of the tab canvas and the left edge of the tab page. The value returned depends on the form coordinate system—pixel, centimeter, inch, or point.
  --  */
  -- FUNCTION TAB_PAGE_X_OFFSET(P_CANVAS IN STD_CANVAS) RETURN VARCHAR2;
  -- FUNCTION GET_TAB_PAGE_X_OFFSET(P_CANVAS IN STD_CANVAS) RETURN VARCHAR2;

  -- PROCEDURE SET_TAB_PAGE_X_OFFSET(P_CANVAS IN STD_CANVAS, P_);


  -- /**
  --  * Returns the distance between the top edge of the tab canvas and the top edge of the tab page. The value returned depends on the form coordinate system—pixel, centimeter, inch, or point.
  --  */
  -- FUNCTION TAB_PAGE_Y_OFFSET(P_CANVAS IN STD_CANVAS) RETURN VARCHAR2;
  -- FUNCTION GET_TAB_PAGE_Y_OFFSET(P_CANVAS IN STD_CANVAS) RETURN VARCHAR2;

  -- PROCEDURE SET_TAB_PAGE_Y_OFFSET(P_CANVAS IN STD_CANVAS, P_);


  /**
   * Returns the name of the tab page currently topmost on the named tab canvas.
   */
  ...
  /**
   * Returns the width of the canvas, specified in the form coordinate units indicated by the Coordinate System form property.
   */
  ...
  /**
   * Returns the name of the visual attribute currently in force. If no named visual attribute is assigned to the canvas, returns CUSTOM for a custom visual attribute or DEFAULT for a default visual attribute.
   */
