CREATE OR REPLACE PACKAGE BODY STD_CANVAS IS
  ...
  BEGIN
    ...
    L_CANVAS.NAME := UPPER(P_CANVAS_NAME);
    L_CANVAS.VIEWPORT := STD_VIEWPORT.NEW(P_CANVAS_NAME);
  ...
  IS
  BEGIN
    RETURN GET_BACKGROUND_COLOR(P_CANVAS);
  ...
  IS
  BEGIN
    RETURN GET_PROPERTY(P_CANVAS, STD_CANVAS_PROPS.BACKGROUND_COLOR);
  ...
  IS
  BEGIN
    SET_PROPERTY(P_CANVAS, STD_CANVAS_PROPS.BACKGROUND_COLOR, P_COLOR);
  ...
  IS
  BEGIN
    RETURN GET_FILL_PATTERN(P_CANVAS);
  END FILL_PATTERN;
  ...
  IS
  BEGIN
    RETURN GET_PROPERTY(P_CANVAS, STD_CANVAS_PROPS.FILL_PATTERN);
  ...
  IS
  BEGIN
    SET_PROPERTY(P_CANVAS, STD_CANVAS_PROPS.FILL_PATTERN, P_PATTERN_NAME);
  ...
  IS
  BEGIN
    RETURN GET_PROPERTY(P_CANVAS, STD_CANVAS_PROPS.FONT_NAME);
  END GET_FONT_NAME;
  ...
  IS
  BEGIN
    SET_PROPERTY(P_CANVAS, STD_CANVAS_PROPS.FONT_NAME, P_FONT_NAME);
  END SET_FONT_NAME;
  ...
  IS
  BEGIN
    RETURN GET_NUMBER_PROPERTY(P_CANVAS, STD_CANVAS_PROPS.FONT_SIZE);
  END GET_FONT_SIZE;
  ...
  IS
  BEGIN
    SET_NUMBER_PROPERTY(P_CANVAS, STD_CANVAS_PROPS.FONT_SIZE, P_SIZE);
  END SET_FONT_SIZE;
  ...
  IS
  BEGIN
    RETURN GET_FONT_SPACING(P_CANVAS);
  END FONT_SPACING;
  ...
  IS
  BEGIN
    RETURN GET_PROPERTY(P_CANVAS, STD_CANVAS_PROPS.FONT_SPACING);
  ...
  IS
  BEGIN
    SET_PROPERTY(P_CANVAS, STD_CANVAS_PROPS.FONT_SPACING, P_SPACING);
  ...
  IS
  BEGIN
    RETURN GET_FONT_STYLE(P_CANVAS);
  END FONT_STYLE;
  ...
  IS
  BEGIN
    RETURN GET_PROPERTY(P_CANVAS, STD_CANVAS_PROPS.FONT_STYLE);
  END GET_FONT_STYLE;
  ...
  IS
  BEGIN
    SET_PROPERTY(P_CANVAS, STD_CANVAS_PROPS.FONT_STYLE, P_STYLE);
  END SET_FONT_STYLE;
  ...
  IS
  BEGIN
    RETURN GET_FONT_WEIGHT(P_CANVAS);
  END FONT_WEIGHT;
  ...
  IS
  BEGIN
    RETURN GET_PROPERTY(P_CANVAS, STD_CANVAS_PROPS.FONT_WEIGHT);
  END GET_FONT_WEIGHT;
  ...
  IS
  BEGIN
    SET_PROPERTY(P_CANVAS, STD_CANVAS_PROPS.FONT_WEIGHT, P_WEIGHT);
  END SET_FONT_WEIGHT;
  ...
  IS
  BEGIN
    RETURN GET_FOREGROUND_COLOR(P_CANVAS);
  ...
  IS
  BEGIN
    RETURN GET_PROPERTY(P_CANVAS, STD_CANVAS_PROPS.FOREGROUND_COLOR);
  ...
  IS
  BEGIN
    SET_PROPERTY(P_CANVAS, STD_CANVAS_PROPS.FOREGROUND_COLOR, P_COLOR);
  ...
  IS
  BEGIN
    RETURN GET_TAB_PAGE_X_OFFSET(P_CANVAS);
  END TAB_PAGE_X_OFFSET;


  FUNCTION GET_TAB_PAGE_X_OFFSET(P_CANVAS IN STD_CANVAS) RETURN NUMBER
  IS
  BEGIN
    RETURN GET_NUMBER_PROPERTY(P_CANVAS, STD_CANVAS_PROPS.TAB_PAGE_X_OFFSET);
  END GET_TAB_PAGE_X_OFFSET;
  

  FUNCTION TAB_PAGE_Y_OFFSET(P_CANVAS IN STD_CANVAS) RETURN NUMBER
  IS
  BEGIN
    RETURN GET_TAB_PAGE_Y_OFFSET(P_CANVAS);
  END TAB_PAGE_Y_OFFSET;


  FUNCTION GET_TAB_PAGE_Y_OFFSET(P_CANVAS IN STD_CANVAS) RETURN NUMBER
  IS
  BEGIN
    RETURN GET_NUMBER_PROPERTY(P_CANVAS, STD_CANVAS_PROPS.TAB_PAGE_Y_OFFSET);
  END GET_TAB_PAGE_Y_OFFSET;
