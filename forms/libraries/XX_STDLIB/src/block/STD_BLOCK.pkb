CREATE OR REPLACE PACKAGE BODY STD_BLOCK IS
  ...
  IS
    ...
    BEGIN 
      IF P_BLOCK_STATUS NOT IN (
        STD_STRUCTURE.RECORD_STATUS.NEW,
        STD_STRUCTURE.RECORD_STATUS.NEW_DIRTY,
        STD_STRUCTURE.RECORD_STATUS.QUERY,
        STD_STRUCTURE.RECORD_STATUS.QUERY_DIRTY
      )
      THEN
  ...
  IS
  BEGIN
    IF GET_STATUS(P_BLOCK) = STD_STRUCTURE.RECORD_STATUS.NEW THEN
      SET_STATUS(P_BLOCK, STD_STRUCTURE.RECORD_STATUS.NEW_DIRTY);
    ELSIF GET_STATUS(P_BLOCK) = STD_STRUCTURE.RECORD_STATUS.QUERY THEN
      SET_STATUS(P_BLOCK, STD_STRUCTURE.RECORD_STATUS.QUERY_DIRTY);
    END IF;
  END SET_DIRTY;
  ...
  IS
  BEGIN
    IF GET_STATUS(P_BLOCK, P_RECORD_NUMBER) = STD_STRUCTURE.RECORD_STATUS.NEW THEN
      SET_STATUS(P_BLOCK, P_RECORD_NUMBER, STD_STRUCTURE.RECORD_STATUS.NEW_DIRTY);
    ELSIF GET_STATUS(P_BLOCK, P_RECORD_NUMBER) = STD_STRUCTURE.RECORD_STATUS.QUERY THEN
      SET_STATUS(P_BLOCK, P_RECORD_NUMBER, STD_STRUCTURE.RECORD_STATUS.QUERY_DIRTY);
    END IF;
  END SET_DIRTY;
  ...
  IS
  BEGIN
    IF GET_STATUS(P_BLOCK) = STD_STRUCTURE.RECORD_STATUS.NEW_DIRTY THEN
      SET_STATUS(P_BLOCK, STD_STRUCTURE.RECORD_STATUS.NEW);
    ELSIF GET_STATUS(P_BLOCK) = STD_STRUCTURE.RECORD_STATUS.QUERY_DIRTY THEN
      SET_STATUS(P_BLOCK, STD_STRUCTURE.RECORD_STATUS.QUERY);
    END IF;
  END SET_PRISTINE;
  ...
  IS
  BEGIN
    IF GET_STATUS(P_BLOCK, P_RECORD_NUMBER) = STD_STRUCTURE.RECORD_STATUS.NEW_DIRTY THEN
      SET_STATUS(P_BLOCK, P_RECORD_NUMBER, STD_STRUCTURE.RECORD_STATUS.NEW);
    ELSIF GET_STATUS(P_BLOCK, P_RECORD_NUMBER) = STD_STRUCTURE.RECORD_STATUS.QUERY_DIRTY THEN
      SET_STATUS(P_BLOCK, P_RECORD_NUMBER, STD_STRUCTURE.RECORD_STATUS.QUERY);
    END IF;
  END SET_PRISTINE;
